...
Feedstock license: [BSD-3-Clause](https://github.com/conda-forge/pymetalink-feedstock/blob/master/LICENSE.txt)
...
<table><tr><td>All platforms:</td>
    <td>
      <a href="https://dev.azure.com/conda-forge/feedstock-builds/_build/latest?definitionId=12112&branchName=master">
        <img src="https://dev.azure.com/conda-forge/feedstock-builds/_apis/build/status/pymetalink-feedstock?branchName=master">
      </a>
    </td>
  </tr>
</table>
...
Once the `conda-forge` channel has been enabled, `pymetalink` can be installed with:

```
conda install pymetalink
```

It is possible to list all of the versions of `pymetalink` available on your platform with:
